(function ($, contToken, sessionID, showAlertDialog) {
  let z;
  function getKey() {
    z = prompt("Please put in your steam API key because this script will call the API to resolve username to steamIDs, type 'skip' to try and use my key");
    if (!z && z !== "skip") getKey();
    return z;
  }
  getKey();
  const API_KEY = z === "skip" ? "61302D7F004BF3578957A3A0CBB0C7AC" : z;
  // -----------
  // Download JS
